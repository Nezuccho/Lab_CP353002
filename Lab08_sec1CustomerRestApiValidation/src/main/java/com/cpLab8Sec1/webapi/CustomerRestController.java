...
import com.cpLab8Sec1.DTO.CustomerRequest;
import com.cpLab8Sec1.DTO.CustomerResponse;
import com.cpLab8Sec1.service.CustomerService;
...
public class CustomerRestController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateCustomer(@PathVariable Long id, @RequestBody @Valid CustomerRequest custReq, BindingResult br) {
		if (br.hasErrors()) {
			Map<String, Object> err = new LinkedHashMap<>();
			err.put("status", 400);
			err.put("error", "Bad Request");
